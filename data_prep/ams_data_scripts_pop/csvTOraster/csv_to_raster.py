...
def csvtoshp(ancillary_POPdata_folder_path,ancillary_data_folder_path,year, dictionary):
    ...
    writer = pd.ExcelWriter(ancillary_POPdata_folder_path + "/{0}/{0}1.xlsx".format(year),  index = False, header=True)
    ...
    gdfXXL.to_file(ancillary_POPdata_folder_path + "/{0}/temp_shp/{0}_dataVectorGrid1.geojson".format(year),driver='GeoJSON',crs="EPSG:3035")
    ...
    gdfL.to_file(ancillary_POPdata_folder_path + "/{0}/temp_shp/{0}_dataVectorGridSums1.geojson".format(year),driver='GeoJSON',crs="EPSG:3035")
