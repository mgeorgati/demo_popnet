...
from variables import country_dictW, country_dict, country_dictTest, country_dictCorrection, country_dictEurope
...
def process_data(ancillary_data_folder_path, ancillary_POPdata_folder_path, parent_path, gdal_rasterize_path, init_csv_to_shp, init_shp_to_tif, create_empty_tif, init_tif_to_png, sum_tifs, 
                merge_tifs_trial01, merge_tifs_trial02,merge_tifs_trial03, city, python_scripts_folder_path):
    ...
    if init_csv_to_shp == "yes":
        ...
        csvtoshp(ancillary_POPdata_folder_path,ancillary_data_folder_path,city)
